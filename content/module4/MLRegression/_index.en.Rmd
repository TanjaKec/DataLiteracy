...
We need to add flexibility to accommodate those limitations. That will allow the use of linear models for **non-linear relationships** and in which the effect of one explanatory variable can be different for different values of the other explanatory variable by introducing the concept of **interaction**. This bring more complexity into the multivariate regression model. 
