...
To compare accuracy between the models we will resample the results of the trained model and compare their accuracy distributions using `caret`'s `resample` function and visualise them with the `dplot()` function.
...
<https://github.com/chanmad/Machine-Learning-on-Bankruptcy>



<http://pages.stat.wisc.edu/~mchung/teaching/MIA/reading/GLM.logistic.Rpackage.pdf>
