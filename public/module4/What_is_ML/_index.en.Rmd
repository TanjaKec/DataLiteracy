...
Often data is arrange sequently and it is a good practice to randomise the rows in the data set prior to the split, as it helps to avoid bias in the fitted model. 

💡 Note, that the $MSE$ above is computed using the _training data_, used to fit the model, and as such it would be more correct to referre to it as the **$training$** **$MSE$**.
